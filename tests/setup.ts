...
if (!Module.prototype.addon) {
  Module.prototype.addon = function() { return {}; };
}

// Global require.addon
if (typeof require !== 'undefined' && !(require as any).addon) {
  (require as any).addon = function() { return {}; };
}
...
vi.mock("bare-os", () => {
    return {
        get default() { return require('os'); },
        get platform() { return require('os').platform; },
        get arch() { return require('os').arch; }
    };
});

vi.mock("bare-fs", () => {
    return {
        get default() { return require('fs'); },
        // Add common exports that might be destructured
        get promises() { return require('fs').promises; },
        get existsSync() { return require('fs').existsSync; }
    };
});

vi.mock("bare-path", () => {
    return {
        get default() { return require('path'); },
        get join() { return require('path').join; },
        get resolve() { return require('path').resolve; }
    };
});

vi.mock("bare-crypto", () => {
    return {
        get default() { return require('crypto'); }
    };
});

vi.mock("bare-fetch", () => ({ get default() { return globalThis.fetch; } }));
