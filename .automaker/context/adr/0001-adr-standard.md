...
**Status**: Accepted
**Date**: 2026-03-14
**Updated**: 2026-03-16 (moved from `.agent/adr/` to `.automaker/context/adr/`)
...
## Decision
We will use the MADR (Markdown Architecture Decision Record) format for tracking decisions. ADRs are stored in `.automaker/context/adr/` with a sequential numbering scheme: `NNNN-relevant-title.md`.
