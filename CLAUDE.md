...
├── hn-digest/                 # Hacker News digest for daily notes
...
```text
.claude/commands/
├── daily-start.md             # Create today's daily note, carry forward from yesterday
├── devin-review.md            # Address Devin PR review flags
├── end-session.md             # Update handoff note with session summary
└── start-session.md           # Hydrate context and orient for the session
```
